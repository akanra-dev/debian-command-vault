...
# Project Goals
This project started as a personal Linux learning tool.
Over time it evolved into a searchable command vault that can help:
...
Current Command Database: 50 / 150 Commands
